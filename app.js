...
const PLACES_API_KEY = 'AIzaSyD641j1ssPqNLQ7b8_AiGT2LyJ0WHHdk7g';
var filteredResults;
...
server.post('/getplaces', (req, res) => {
  ...
  const locationReq = `https://maps.googleapis.com/maps/api/geocode/json?address=${addr}&key=AIzaSyD641j1ssPqNLQ7b8_AiGT2LyJ0WHHdk7g`;
